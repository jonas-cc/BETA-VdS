...
import com.example.villadelsol.ConfirmedDate;
import com.example.villadelsol.R;
import com.example.villadelsol.UpdateDate;
...
public class CitasFragment extends Fragment {
    ...
    public void eliminar() {
        ...
        if (value.equals("")) {
            ...
            url = "https://node-villa-del-sol.herokuapp.com/api/borrarCita/"+value;
            StringRequest respuesta3 = new StringRequest(Request.Method.DELETE, url, new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    Toast.makeText(getActivity(), response, Toast.LENGTH_SHORT).show();

                    Intent confirm_date = new Intent(getActivity(), ConfirmedDate.class);
                    confirm_date.putExtra("nombre", "Usuario");
                    confirm_date.putExtra("correo","correspondiente");
    ...
    public void validarID(){
        ...
        JsonObjectRequest respuestaBusqueda=new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                Intent confirm_update =new Intent(getActivity(), UpdateDate.class);
