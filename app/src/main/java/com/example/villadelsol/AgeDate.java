...
public class AgeDate extends AppCompatActivity {
    ...
    public void relacionarVistas(){
        ...
        txtEvento=(EditText) findViewById(R.id.txtEvento); //LO MODIFIQUÉ
        txtInvitados=(EditText) findViewById(R.id.txtInvitados1); //LO MODIFIQUÉ
    ...
    public void insercion(View v){
        ...
        url="https://node-villa-del-sol.herokuapp.com/api/registrarCita";
    ...
    private void webServices() {
        ...
        StringRequest respuestaConsulta= new StringRequest(Request.Method.POST,
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Cnombre=correo.getText().toString();
                        Ccorreo=nombre.getText().toString();
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length() ; i++) {
                                ...
                                correo.append(cita.getString("nombre"));
                                nombre.append(cita.getString("correo"));
        ...
        protected Map<String, String> getParams() throws AuthFailureError {
            ...
            params.put("nombre", correo.getText().toString());
            params.put("correo", nombre.getText().toString());
